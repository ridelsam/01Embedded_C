...
.L14:
	...
	bl	__io_getchar
	mov	r1, r0
	.loc 1 105 7 discriminator 3
	ldr	r3, [r7, #8]
	adds	r2, r3, #1
	str	r2, [r7, #8]
	.loc 1 105 10 discriminator 3
	uxtb	r2, r1
	strb	r2, [r3]
...
.LFB31:
	...
	b	.L17
.L18:
	.loc 1 118 20 discriminator 3
	ldr	r3, [r7, #8]
	adds	r2, r3, #1
	str	r2, [r7, #8]
	.loc 1 118 3 discriminator 3
...
.LASF761:
	...
	.ascii	" (0)\000"
.LASF1422:
	.ascii	"C:/Users/rsamonte/Embedded Systems/Embedded C/My_Wo"
	.ascii	"rkspace/target/003Add/Debug\000"
.LASF537:
...
.LASF1420:
	...
	.ascii	"fpu=fpv4-sp-d16 -mfloat-abi=hard -mthumb -march=arm"
	.ascii	"v7e-m+fp -g3 -O0 -std=gnu11 -ffunction-sections -fd"
	.ascii	"ata-sections -fstack-usage\000"
.LASF410:
