...
#define ADDR_REG_GPIOD_OD		( (GPIOx_MODE_t*) 0x40020000)

#define CLOCK_ENABLE			(1)
#define D_MODE_CONF_OUTPUT		(1)
#define A_MODE_CONF_INPUT		(0)
#define D_PIN_12_HIGH			(1)
#define D_PIN_12_LOW			(0)
...
typedef struct
{
	...
	uint32_t	bkpsram_eh		:1;
	uint32_t	reserved3		:1;
	uint32_t	ccmdataram_eh	:1;
	uint32_t	dma1_en			:1;
	uint32_t	dma2_en			:1;
